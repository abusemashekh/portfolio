  ...
  ProjectModel(
    ...
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=com.synergis.adept&pli=1'),
      AppLink(
          platform: 'iOS',
          link:
              'https://apps.apple.com/in/app/synergis-adept-mobile/id6456038329'),
    ],
    images: [
      Assets.projects.adept.a1.path,
      Assets.projects.adept.a2.path,
      Assets.projects.adept.a3.path
    ],
  ),
  ProjectModel(
    ...
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=com.rentrx.app.rent_rx'),
    ],
    images: [
      Assets.projects.rentRx.a1.path,
      Assets.projects.rentRx.a2.path,
      Assets.projects.rentRx.a3.path
    ],
  ),
  ProjectModel(
    ...
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=com.shootyourshot'),
      AppLink(
          platform: 'iOS',
          link:
              'https://apps.apple.com/us/app/shoot-your-shot-dating-app/id1497413070'),
    ],
    images: [
      Assets.projects.shootYourShot.a1.path,
      Assets.projects.shootYourShot.a2.path,
      Assets.projects.shootYourShot.a3.path
    ],
  ),
  ProjectModel(
    ...
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=io.bunifu.go.parent.jga2'),
      AppLink(
          platform: 'iOS',
          link:
              'https://apps.apple.com/eg/app/jonathan-gloag-parent/id1624217623'),
    ],
    images: [
      Assets.projects.bunifu.a1.path,
      Assets.projects.bunifu.a2.path,
      Assets.projects.bunifu.a3.path
    ],
  ),
  ProjectModel(
    ...
    images: [
      Assets.projects.greenWell.a1.path,
      Assets.projects.greenWell.a2.path,
      Assets.projects.greenWell.a3.path
    ],
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=com.green_well.biotech'),
    ],
  ),
  ProjectModel(
    ...
    appLinks: [
      AppLink(
          platform: 'Android',
          link:
              'https://play.google.com/store/apps/details?id=com.aarchiev.aarchievgold'),
      AppLink(
          platform: 'iOS',
          link:
              'https://apps.apple.com/in/app/aarchiev-gold-jewellery-store/id1664321022'),
    ],
    images: [
      Assets.projects.aarchiev.a1.path,
      Assets.projects.aarchiev.a2.path,
      Assets.projects.aarchiev.a3.path
    ],
  ),
  ProjectModel(
    ...
    images: [Assets.projects.tadda.a1.path],
  ),
  ProjectModel(
    ...
    tools: ['Flutter', 'Provider', 'REST API', 'Firebase'],
    images: [Assets.projects.holy11.a1.path],
  ),
];
